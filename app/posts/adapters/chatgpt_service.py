    ...
    def get_products_by_dish(self, dish_name:str) -> list[str]:
        ...
        completion = openai.ChatCompletion.create(
            ...
            messages=[
                ...
                {"role": "user", "content": "напиши список продуктов для приготовления блюда " + prompt + " и укажи категорию для каждого продукта исходя из его названия и предназначения. Напиши название продукта. Напиши ответ в виде название продукта, категории и ничего лишнего. Если зелень, мясо, специи то сразу уточни какая, не используй слово зелень. НЕ ИСПОЛЬЗУЙ СВИНИНУ. ВМЕСТО ПШЕНИЧНАЯ МУКА ПИШИ МУКА. Если растительное масло то напиши сразу какой подсолнечное масло или другие виды. Пиши название продукта - категорию. Convert answer to JSON format."}
