    ...
    def get_products_by_dish(self, dish_name:str) -> list[str]:
        ...
        completion = openai.ChatCompletion.create(
            ...
            messages=[
                ...
                {"role": "user", "content": "напиши список продуктов для приготовления блюда " + prompt + ". НЕ ИСПОЛЬЗУЙ СВИНИНУ. ВМЕСТО ПШЕНИЧНАЯ МУКА ПИШИ МУКА. Если растительное масло то напиши сразу какой подсолнечное масло или другие виды.Convert answer to JSON format."}
