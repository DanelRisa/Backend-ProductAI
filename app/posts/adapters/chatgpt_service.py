...
class ChatGPTService:
    ...
    def get_product_by_category(self, product_name:str) ->str:
        ...
        completion = openai.ChatCompletion.create(
            ...
            messages=[
                {"role": "system", "content": "You are a helpful assistant."},
                {"role": "user", "content": "определи в какой из перечисленных категорий относится " + prompt + " исходя из названия продукта и его предназначения: . Пиши название продукта - категорию. Convert answer to JSON format"},
            ],
            max_tokens=9000,
            n=1,
            stop=None,
